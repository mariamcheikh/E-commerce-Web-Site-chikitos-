    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <li><a href="Dashboard.php"><span class="glyphicon glyphicon-user"></span> Gerer les Comptes</a></li>
            ...
            <li><a href="#"><span class="glyphicon glyphicon-cog"></span> Parametre du compte</a></li>
...
<table>
<tr>
<td>nom</td><td><input type="text" name="nom" value="" title="Only letters" pattern="[a-zA-Z]+" required></td><td><input type="submit"  name="recherche" required></td>
</tr>
</table>
</form>
</body>
...
$cc=new crudContact();
if (isset($_GET["nom"])){
	$resultat=$cc->rechercherContact($_GET["nom"],$cc->conn);
	//var_dump($resultat);
	?>
	<h2>Résultat de recherche</h2>
	<?PHP
	if (empty($resultat))
		echo "Aucun contact trouvé avec le Nom choisi";
	else{
	?>
