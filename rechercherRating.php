    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="panel-heading">Gestion des Rating</div>
...
if (isset($_GET["user_id"])){
	$resultat=$cc->rechercherRating($_GET["user_id"],$cc->conn);
	//var_dump($resultat);
	?>
	<h2>Résultat de recherche</h2>
	<?PHP
	if (empty($resultat))
		echo "Aucun rating trouvé";
	else{
	?>
...
?>
<a href="interfaceAjoutR.html"> Ajouter Un Nouveau rating</a>
