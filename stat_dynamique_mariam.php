...
$total10 = $cc->calcul_statistique_10 ($cc->conn);
$total30 = $cc-> calcul_statistique_30($cc->conn);
//$total50 = $cc-> calcul_statistique_50($cc->conn);
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Statistiques des reclamations'
        },
        tooltip: {
        ...
        plotOptions: {
          ...
          series: [{
            ...
            data: [{
                name: 'traité %',
                y: <?php echo $total10[0] ?>
            }, {
                name: 'En attente %',
                y: <?php echo $total30[0] ?>,
