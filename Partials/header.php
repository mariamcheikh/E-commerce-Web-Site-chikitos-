...
<!-- header -->
  ...
  <a href="index.html"><img src="Fonts/chikitos_converted.png" alt=" " class="img-responsive" /></a>
				</div>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active">
								<a href="affRéservation_trait.php" class="dropdown-toggle act" data-toggle="dropdown">Réservation <b class="caret"></b></a>
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Table</h6>
												<li><a href="interface_ajout_réservation_traiteur.php">Ajout une Réservation</a></li>
												<li><a href="affRéservation_trait.php">Afficher les réservation</a></li>
												<li><a href="#">Consulter les table disponible</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Traiteur</h6>
												<li><a href="furniture.html">Ajout une Réservation</a></li>
												<li><a href="furniture.html">Afficher les réservation</a></li>
												<li><a href="furniture.html">Consulter les traiteur disponible</a></li>
