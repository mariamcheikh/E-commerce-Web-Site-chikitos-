...
if (isset($_POST['Modif2'])) {
    if (isset($_POST['date_res']) && isset($_POST['per_res'])) {
        ...
        $trai->setId_tra($_GET['Var']);
        $trai->setPeriode($_POST['per_res']);
        $trai->setDate_reserv($_POST['date_res']);
      //  $c->Inserttrai($conn, $trai);
        $c->UpdateReserv_trai($conn, $trai);
    }
}
$req = $c->SearchReserv_trait($conn,$_GET['Var']);
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="panel-body">
            ...
            <form id="registration-form" method="POST" class="form-horizontal" action="#">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" id="lastname" name="per_res" value="<?php echo $data['Periode']; ?>"  required>
                    </div>
                </div>
        </div>
        <button type="submit" id="bt_enr" name="Modif2" class="btn" style="margin-left:50px;">Enregistrer</button>
    </div>
    </form>
</div>
