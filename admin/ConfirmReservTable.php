...
if (isset($_POST['Engr'])) {
  $cc->ConfirmReservTabl($conn,$_POST['delete']);
}
if (isset($_POST['Engr2'])) {
  $cc->AnnulReservTabl($conn,$_POST['Var']);
}

$req = $cc->DisplayReservTabl($conn);
 ?>
 ...
 <div class="panel-body">
       ...
       <table class="table table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Nombre de personne par table</th>
                        <th>Confirmation</th>
                      </tr>
                    </thead>
                    <tbody>
  ...
  ?>
                      <tr>
                        <td>
                          <form id="registration-form" method="POST" class="form-horizontal" action="ConfirmReservTable.php" style="margin-left:7px;">
                   					<div class="form-group">
                              <button type="submit" id="Conf_b" name="Engr" class="btn" onclick="return confirm('Vous etes sur !!!!');" >Confirmer</button>
                              <input type="text" name="delete" value="<?php echo $data['Id_table']; ?>" hidden>
                            </div>
                          </form>
                          <form id="registration-form" method="POST" class="form-horizontal" action="ConfirmReservTable.php" style="margin-left:7px;">
                            <div class="form-group">
