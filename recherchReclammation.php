...
<body>
<h1>Recherche par le numero d'identifiant</h1>
<form method="GET">
<table>
<tr>
<td>veuillez entre l'etat de la reclammation:</td><td><input type="text" name="etat" value="" pattern="[a-zA-Z]+" required></td><td><input type="submit" name="recherche" required></td>
</tr>
</table>
</form>
</body>
...
if (isset($_GET["etat"])){
	$resultat=$cc->rechercherReclammation($_GET["etat"],$cc->conn);
	//var_dump($resultat);
	?>
	<h2>Résultat de recherche</h2>
	<?PHP
	if (empty($resultat))
		echo "Aucune reclammation trouvé avec l'identifiant choisi";
	else{
	?>
    ...
    ?>
	<tr>
	<td><?php echo $l['messageR'] //$l[1]?></td>
   <td><?php echo $l['user_id'] //$l[1]?></td>
