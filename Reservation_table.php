...
if (isset($_POST['Engr1'])) {
	$c->DeleteResrv_tab($conn,$_POST['delete']);
}
$req = $c->DisplayReservTable($conn);
?>
...
<!-- register -->
	...
	<div class="container">
        ...
        <option value="nbr">Organiser par nombre de personne</option>
        </select>
        </form>
                     ...
                     <tbody>
                       ...
                       <tr ng-repeat="comment in comments | filter:query | orderBy:order">
                         <td>
                           ...
                           <form id="registration-form" method="GET" class="form-horizontal" action="ModifReservTable.php" style="margin-left:7px;">
                             <div class="form-group">
                             <button type="submit" id="Modif_b" name="Engr" class="btn btn-warning" >Modifier</button>
