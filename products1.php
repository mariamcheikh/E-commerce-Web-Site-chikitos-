...
$comm=new commande($user,0,0,0,0,0);
			...
			<div class="header-grid">
				...
				<div class="header-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<ul class="social-icons">
						...
						<li><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://localhost/AtelierPHP/projet/furniture.php" send="true" layout="button_count" width="80" show_faces="true" font=""></fb:like></li>
					</ul>
				</div>
			...
			<div class="logo-nav">
				...
				<div class="header-right">
					<div class="cart box_1">
						<a href="checkout.php">
							<h3> <div class="total">
								<span><?php echo $comm->calcultotal($cc->conn,$user) ?> DNT</span></br> (<span ><?php echo $comm->getnumberproduit($cc->conn,$user) ; ?></span> items)</div>
...
<!-- breadcrumbs -->
			...
			<div class="row">
				...
				<div class="products-right-grids-bottom" >
					<div class="col-md-4 products-right-grids-bottom-grid"  >
						...
						<!-- nooor -->
						<div class="thumbnail" height="100px" width="100px">

					      <!--<img src="..." alt="...">-->
					      <a href="single.html" class="product-image"><?php echo '<img    src="data:image;base64,'.base64_encode($l['image']).'" alt=" " class="img-responsive" />'; ?></a>
					      
					      <div class="caption" height="100px" width="100px">
					        <h4><a href="single.php"><?php echo $l['nom']; ?></a></h4>
							
							<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.php?nom=<?php echo $l['nom']; ?>">Quick View</a>
								</div>
						<input type="checkbox" name="add[]" value="<?php echo $l['idproduit']?>">
				...
				<div class="container">
		                <input type="submit" value="ajouter au panier"  data-toggle="modal" data-target="#myModal" class="btn btn-danger">
	...
	<a href="quiz1.html">Participez allez !!!</a>
<!-- //breadcrumbs -->
<!-- footer -->
	<div class="footer">
		<div class="container">
