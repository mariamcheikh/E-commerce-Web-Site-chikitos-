...
if (!empty($_POST)) {
$EmailVal->set_email($_POST['email']);
?>
<span class = "hidden-lg">
		<?php
		if ($EmailVal->send_emailpassword($DB)==true) { 
			?>
		</span>
			<div class="alert alert-success">
		  <strong>Success!</strong> Un Email a ete envoyer a votre Adresse mail.
		</div>
	<?php	
			}
}
?>
	    ...
	    <div class="login animated wow zoomIn" data-wow-delay=".5s">
            ...
            <p>Veuillez fournir l'adresse mail utiliser lors de votre inscription. Un email vous sera envoyé pour vous permettre de reinitalise votre mot de passe</p>
          </div>
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form id="login-form" method="POST" action="forgotpassword.php">
