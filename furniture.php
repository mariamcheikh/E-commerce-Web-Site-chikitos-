...
$cc=new crudProduit();
	...
	$prodd=$cc->affiche2($conn);

		$comm=new commande($_SESSION['user_session'],0,0,0,0);
		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="furniture.php">plus vendues</a> <span>(15)</span></li>
						<li><a href="furniture.php">nos spécialitées</a> <span>(16)</span></li>
							<ul>
								<li><a href="furniture.php">pizza</a> <span>(10)</span></li>
								<li><a href="furniture.php">plats</a> <span>(5)</span></li>
								<li><a href="furniture.php">menu</a> <span>(1)</span></li>
								<li><a href="furniture.php">garniture</a> <span>(0)</span></li>
								<li><a href="furniture.php">Mc frites</a> <span>(1)</span></li>
							</ul>
					...
					<div class="new-products-grids">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-right">
								<h4><a href="single.html">Norvegienne double pate</a></h4>
					  ...
					  <div class="col-md-4 products-right-grids-bottom-grid">
					    <div class="thumbnail">
					      ...
					      <div class="caption">
					        ...
					        <input type="text" value="<?php echo $donnees['idproduit']?>"></input>
