	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active" <span class="glyphicon glyphicon-home" aria-hidden="true"></span>reclammation</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- mail -->
	<div class="mail animated wow zoomIn" data-wow-delay=".5s">
		...
		<br>
		<br>
	<p>Si nous n’avons pas su vous donner entière satisfaction, veuillez nous faire part de vos suggestions ou réclamations. </p>
	<br>
		<br>
		<br>
				  <form id="contact-form" method="POST" action="ajoutReclammation.php" >
<div class="col-md-8 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
		  
					
				<p> veuillez entrer votre reclammation </p>
				<tr><textarea style="margin-bottom:15px" type="text" name="messageR" required ></textarea></tr>
				<p> l'etat de votre reclammation  pour le moment est: </p>
				<tr><input style="margin-bottom:15px" type="text"  name="etat" Value="En attente" required  readonly></tr>
				
				<tr><input type="submit"  name="ajouter" value="ajouter" ></tr>
			</div>
		</form>
	</div>
				<div class="clearfix"> </div>
