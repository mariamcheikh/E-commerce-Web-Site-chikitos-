...
if (isset($_POST["supprimer"])){
	$cc->supprimerReclammation($_POST["id_reclammation"],$cc->conn);
	
}

$list=$cc->afficheReclammation($cc->conn);
	//var_dump($list);
	?> 
	<h1>Liste des reclammations</h1>
	...
	<tr>
		...
		<td><?php echo $l['messageR']?></td>
		<td><?php echo $l['etat']?></td>
		<td><?php echo $l['user_id']?></td>


	<td><a href="modifReclammation.php?id_reclammation=<?php echo $l['id_reclammation']; ?>">Modifier</a></td>
	
	<td><form action="" method="POST">
	<input type="submit" value="supprimer" name="supprimer">
	<input type="text" value="<?PHP echo $l['id_reclammation'] ?>" name="id_reclammation" hidden>
	</form> </td>
	...
	?>
		 ...
		 <a href="index.php"> Envoyer une SMS de confirmation </a>
		  <br>
		 <br>
         <a href="recherchReclammation.php">Rechercher une réclammations par son état</a>
		 
 <br>
		 <br>		 
		  <a href="statistique_mariam.php"> Aficher les statistiques des réclammations  (statique)</a>
		   <br>
		 <br>
			  <a href="stat_dynamique_mariam.php"> Aficher les statistiques des réclammations(dynamique)</a> 
		 <br>
		 <br>
		 <br>
