			...
			<div class="logo-nav">
				...
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						...
						<li class="active" ><a href="reclammation.php" class="act">reclammation</a></li>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">reclammation</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
...
if (isset($_POST['messageR']) and isset($_POST['etat']))
 {
	
$recttt=new Reclammations($_POST['messageR'],$_POST['etat']);	

$cc->insertReclammation($recttt,$cc->conn);
...
//header ('location:index_sms_mariam.php');
	...
	echo'<body onLoad="alert(\'Votre Insertion n est pas  effectuée avec succès..\')">';
