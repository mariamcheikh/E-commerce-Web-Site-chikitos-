...
<head>
    ...
    <meta name="rating" content="Your rating here">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="panel-heading">Gestion du rating</div>
...
$list=$cc->afficheRating($cc->conn);
	//var_dump($list);
	?> 
	<h1>Liste des rating</h1>
	<table border="1" class="responstable">
	<tr>
	<td>user_id</td><td>id_produit</td><td>rating</td><td>Suppression</td>
	</tr>
	...
	<td><?php echo $l['rating']?></td>
	
	
	<td><a href="modifierRating.php?user_id=<?php echo $l['user_id']; ?>">Modifier</a></td>
    ...
    <a href="interfaceAjoutR.html">Interface Ajout des rating</a>
	<br></br>
	
	 <a href="rechercherRating.php">Interface De Recherche Des Commentaires</a>
