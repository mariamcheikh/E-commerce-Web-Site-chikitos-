...
<link href="css/chatt.css" rel="stylesheet">
                ...
                <div class=" col-md-9 col-lg-9 ">
                  <table class="table table-striped" style=" margin-left: 170px;">
                    <tbody>
                       ...
                       $User->display_accountinfo($DB);
                       ?>
                    </tbody>
                  </table>

                  <a href="User_AccountSetting.php" class="btn btn-warning">Modifier Information <i class="glyphicon glyphicon-edit"></i></a>
...
<!-- //register -->
     ...
     if(!empty($_POST))
     {
  $Chat->set_userID($_SESSION['user_session']);
  $Chat->set_message($_POST['message']);
  $Chat->newmessage($DB);
	 }
       ?>
    <div class="container">
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="panel-collapse collapse" id="collapseOne">
                <div class="panel-body chatb" id="reload">
                ...
                <form class="form-chat" method="POST" action="User_Account.php">
