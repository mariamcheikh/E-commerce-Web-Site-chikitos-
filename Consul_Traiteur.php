...
<!-- register -->
	...
	<div class="container">
        ...
        <option value="Telephone">Organiser par numero téléphone</option>
        ...
        <table class="table table-striped">
                     ...
                     <tbody>
                       ...
                       <tr ng-repeat="comment in comments | filter:query | orderBy:order">
                         <td>
                           <form id="registration-form" method="GET" class="form-horizontal" action="AjoutReserv_trait.php" style="margin-left:7px;">
                             <div class="form-group">
                               <button type="submit" id="Supp_b" name="Engr" class="btn btn-success">Réserver</button>
                               <input type="text" name="insert" value="{{comment.Id}}" hidden>
                             </div>
                           </form>
					...
					app.controller('commentsCtrl',function commentsCtrl ($scope) {console.log($scope);
						$scope.comments = [
							...
							?>
							{
								...
								"Telephone":"<?php echo $data['Num_tele']; ?>",
								"Prix":"<?php echo $data['salaire_plats']; ?>",
							},
							<?php
							}
							?>
