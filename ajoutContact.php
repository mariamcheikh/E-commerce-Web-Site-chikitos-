		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">contact@chikitos-tunisie.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+216 <span> 23 </span> <span> 220 </span> 616</li>
				...
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="contact.html" class="act">Contactez Nous</a></li>
						</ul>
					</div>
					</nav>
				</div>
...
<!-- mail -->
	...
	<br>
		...
		<br>
<?php
include("index_sms_mariam.php");
include ("crudContact.php");

$cc=new crudContact(); 

if (isset($_POST['nom']) and isset($_POST['telephone'])and isset($_POST['mail']) and isset($_POST['message']))
 {
$contt=new Contact($_POST['nom'],$_POST['telephone'],$_POST['mail'],$_POST['message']);	
$cc->insertContact($contt,$cc->conn);
echo'<body onLoad="alert(\'Votre Insertion est effectuée avec succès..\')">';
echo "Bienvenue chez Chikitos nous vous y répondrons aussi vite que possible Merci de nous avoir contactés";
}
else{
echo'<body onLoad="alert(\' Votre Insertion n est pas effectuée par  succès..\')">';  
  echo "Insertion n'est pas effectuée par  succès";
header ('location:index_sms_mariam.php');
}
?>	
				</div>
				<div class="clearfix"> </div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="index.html">CHikitos Restaurant <span>vini vidi vici</span></a></h2>
			</div>
